...
crossroads = soup.find_all("li", class_="Crossroads")[0]
meals = crossroads.find_all("li", class_="preiod-name")
...
from main import Flask, request
import requests
